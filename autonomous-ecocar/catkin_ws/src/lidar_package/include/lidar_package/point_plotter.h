...
#define FRAME_ID "visualization_frame"

#include <string> 

#define NUMBER_OF_DISTINCT_COLORS 269
const uint32_t distinct_colors[] = { // 269 colors
...
extern pcl::PointCloud<pcl::PointXYZRGB>::Ptr colorClouds(std::vector< pcl::PointCloud<pcl::PointXYZ>::Ptr > * clouds, std::vector<int> * color_id_vector = 0);
extern pcl::PointCloud<pcl::PointXYZRGB>::Ptr coloredCloud(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, int r, int g, int b);
extern visualization_msgs::Marker makePoints(pcl::PointCloud<pcl::PointXYZ> * pointList, float r = 1.0, float g = 1.0, float b = 1.0, std::string ns = "points", int id = 1, float alpha = 1.0, float size = 0.2);
extern visualization_msgs::Marker makeLineStrip(pcl::PointCloud<pcl::PointXYZ> * pointList, float r = 1.0, float g = 1.0, float b = 1.0, std::string ns = "linestrip", int id = 1, bool loop = false, float thickness = 0.02);
extern visualization_msgs::Marker makeLineList(pcl::PointCloud<pcl::PointXYZ> * pointListA, pcl::PointCloud<pcl::PointXYZ> * pointListB, float r = 1.0, float g = 1.0, float b = 1.0, float thickness = 0.1, float alpha = 1.0, std::string ns = "lineslist", int id = 1);
extern visualization_msgs::Marker makePlanes(pcl::PointCloud<pcl::PointXYZ> * pointList, float r = 1.0, float g = 1.0, float b = 1.0, bool reverse = false, std::string ns = "plane", int id = 1);
extern visualization_msgs::Marker makeGrids(pcl::PointCloud<pcl::PointXYZ> * pointList, int n, float r = 1.0, float g = 1.0, float b = 1.0, float thickness = 0.1, std::string ns = "grids", int id = 1);
extern void makeBoxPoints(Extreme * extreme, pcl::PointCloud<pcl::PointXYZ>::Ptr point_cloud);
