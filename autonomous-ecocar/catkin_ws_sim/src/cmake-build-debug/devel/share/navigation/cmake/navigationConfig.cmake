...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/dlsh/gazebo/autonomous-ecocar/catkin_ws_sim/src/navigation)
  set(navigation_DEVEL_PREFIX /home/dlsh/gazebo/autonomous-ecocar/catkin_ws_sim/src/cmake-build-debug/devel)
...
if(NOT "/home/dlsh/gazebo/autonomous-ecocar/catkin_ws_sim/src/navigation/include " STREQUAL " ")
  set(navigation_INCLUDE_DIRS "")
  set(_include_dirs "/home/dlsh/gazebo/autonomous-ecocar/catkin_ws_sim/src/navigation/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlsh/gazebo/autonomous-ecocar/catkin_ws_sim/src/navigation/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;std_msgs;std_srvs;message_runtime;dynamo_msgs;tf2_ros;tf2;geometry_msgs")
