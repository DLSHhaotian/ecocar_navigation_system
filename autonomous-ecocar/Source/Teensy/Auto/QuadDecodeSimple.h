...
public:
	QuadDecode_t() {
		...
		FTM2_C0V = (360 - 20) * 4;    //(360 - degree_the_ignition_should_activate) + calibration_variable; // Initial Compare Interrupt Value // Shot in the dark // And you're to blame

		FTM2_C1SC = 0x10;
		FTM2_C1V = (360 + 20) * 4;    //startAngle_inj;

									  // Maybe not, incomment if it doesn't work
		FTM2_C0SC = 0x50;       // Enable Channel interrupt
		FTM2_C1SC = 0x50;       // Enable Channel interrupt
